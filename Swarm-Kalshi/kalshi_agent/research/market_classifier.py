...
_TICKER_PREFIX_RULES: List[_TickerRule] = [
    ...
    ("KXHIGHT", "ECONOMICS", "interest_rate",
     dict(researchability=88, sources=["federalreserve.gov", "CME FedWatch"],
          strategy="official_data", queries=7, tags=["scheduled_event"],
          reasons=["Rate decisions follow known FOMC calendar"])),
